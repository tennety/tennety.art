    ...
    <main className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-16 max-w-2xl">
        <div className="mb-8 text-center">
          <h1 className="text-5xl font-bold mb-3 pb-2 border-b text-foreground border-border">About</h1>
          <p className="text-xl mb-6 text-muted">
            Hi! I&apos;m Chandu, an independent comics creator, cartoonist, and illustrator from Central Ohio.
          </p>
          <p className="text-md mb-6 text-foreground">
          ...
          <Link href="/" className="inline-block hover:underline text-sm font-medium text-accent">&larr; Back to Home</Link>
        </div>
      </div>
    </main>
  )
